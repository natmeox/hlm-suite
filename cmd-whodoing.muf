...
: main  ( str -- )
    ...
    count @ "\[[1;37m%i players shown of %i online (max connected is %i)." fmtstring .tellgood
;
.
c
q

lsedit cmd-whodoing=_help
.del 1 $
wd [<name>]
wd #wf [<name>]
wd #species [<name>]
...
List the names, on times, idle times, and doings for everyone online. If a <name> is given, only lists people whose names start with <name>. wd #wf only lists people in your watchfor list, and wd #room only lists people in the room with you. wd #species lists species settings instead of doings. The #def options lets you set the default options for your use of wd.
.format 7=78
.end
